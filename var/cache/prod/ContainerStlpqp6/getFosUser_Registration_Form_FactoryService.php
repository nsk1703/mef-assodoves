...
return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory(${($_ = isset($this->services['form.factory']) ? $this->services['form.factory'] : $this->load('getForm_FactoryService.php')) && false ?: '_'}, 'fos_user_registration_form', 'User\\UserBundle\\Form\\RegistrationFormType', $this->parameters['fos_user.registration.form.validation_groups']);
