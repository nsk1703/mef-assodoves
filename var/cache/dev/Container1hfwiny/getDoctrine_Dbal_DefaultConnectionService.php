...
$c->addEventSubscriber(${($_ = isset($this->services['stof_doctrine_extensions.listener.loggable']) ? $this->services['stof_doctrine_extensions.listener.loggable'] : $this->getStofDoctrineExtensions_Listener_LoggableService()) && false ?: '_'});
...
$c->addEventSubscriber(${($_ = isset($this->services['stof_doctrine_extensions.listener.translatable']) ? $this->services['stof_doctrine_extensions.listener.translatable'] : $this->getStofDoctrineExtensions_Listener_TranslatableService()) && false ?: '_'});
$c->addEventListener([0 => 'loadClassMetadata'], ${($_ = isset($this->services['doctrine.orm.default_listeners.attach_entity_listeners']) ? $this->services['doctrine.orm.default_listeners.attach_entity_listeners'] : ($this->services['doctrine.orm.default_listeners.attach_entity_listeners'] = new \Doctrine\ORM\Tools\AttachEntityListenersListener())) && false ?: '_'});

return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'c1462208c_mef_doves', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => [], 'defaultTableOptions' => []], $a, $c, []);
